...
VALUES (1, 100001, 101, '随机积分', NULL, 80000, 80000, 0.3000, 'tree_luck_award', 1),
       ...
       (22, 100006, 101, '随机积分', NULL, 100000, 100000, 0.0200, 'tree_luck_award', 1),
       (23, 100006, 102, 'OpenAI会员卡', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 2),
       (24, 100006, 103, '支付优惠券', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 3),
       (25, 100006, 104, '小米台灯', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 4),
       (26, 100006, 105, '小米su7周体验', '抽奖3次后解锁', 100000, 100000, 0.0300, 'tree_lock_3', 5),
       (27, 100006, 106, '轻奢办公椅', '抽奖2次后解锁', 100000, 100000, 0.0300, 'tree_lock_2', 6),
       (28, 100006, 107, '小霸王游戏机', '抽奖1次后解锁', 100000, 100000, 0.0300, 'tree_lock_1', 7),
       (29, 100006, 108, '暴走玩偶', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 8);
/*!40000 ALTER TABLE `strategy_award`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 100301, '测试活动', '测试活动', '2026-03-09 10:15:10', '2034-03-09 10:15:10', 100006, 'open');
/*!40000 ALTER TABLE `raffle_activity`
    ENABLE KEYS */;
UNLOCK TABLES;
