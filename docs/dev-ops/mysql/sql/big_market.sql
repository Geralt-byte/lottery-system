...
VALUES (1, 100001, 101, '随机积分', NULL, 80000, 80000, 0.3000, 'tree_luck_award', 1),
       ...
       (23, 100006, 102, '7等奖', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 2),
       (24, 100006, 103, '6等奖', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 3),
       (25, 100006, 104, '5等奖', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 4),
       (26, 100006, 105, '4等奖', NULL, 100000, 100000, 0.0300, 'tree_luck_award', 5),
       (27, 100006, 106, '3等奖', '抽奖1次后解锁', 100000, 100000, 0.0300, 'tree_lock_1', 6),
       (28, 100006, 107, '2等奖', '抽奖1次后解锁', 100000, 100000, 0.0300, 'tree_lock_1', 7),
       (29, 100006, 108, '1等奖', '抽奖2次后解锁', 100000, 100000, 0.0300, 'tree_lock_2', 8);
